...
out_md_file="out/slides_ver_5.md"
out_md_category_file = "out/category_ver_5.md"
out_pptx_file="out/slides_ver_5.pptx"

file_csv="csv/wb.csv"

# получить словари с описанием продуктов 
products = ds.get_products(file_csv)
...
for product in sorted_products:
    if product["category"] != current_category:
        ...
        current_category_template_file = "out/version_category_5." + str(product['category']) + ".md"
    ...
    current_template_file = "out/version_5." + str(product['product_id']) + ".md"
    # добавить имя файла в список для объединения
